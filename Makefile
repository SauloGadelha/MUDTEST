...
PROF    = -O0 -g
RELEASE = -O3
C_FLAGS =  -Wall -Wno-parentheses -Wno-char-subscripts -fpermissive -Wno-narrowing -Wno-write-strings $(PROF) $(NOCRYPT) 
L_FLAGS =  -lm -lcrypt -L/usr/local/lib/mysql/ -lmysqlclient $(PROF)
...
O_FILES = act_comm.o act_enter.o act_info.o act_move.o act_obj.o act_wiz.o AirTitles.o \
	      ...
	      version.o WaterTitles.o Reclass.o
...
rom: $(O_FILES)
	$(CC) $(L_FLAGS) -o avendar $(O_FILES) -lcrypt `mysql_config --libs`
